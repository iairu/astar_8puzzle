...
for i in range(0,100): # run tests 100 times (around 9min)
    ...
    AStar.explore(State(3,[3,2,8,4,5,6,7,1,0]), State(3,[1,2,3,4,5,6,7,8,0]), 2)
    ...
    start = time.perf_counter()
    AStar.explore(State(3,[3,2,8,4,5,6,7,1,0]), State(3,[1,2,3,4,5,6,7,8,0]), 2, 500)
    totalraw = time.perf_counter() - start
    total = str(round(totalraw,6))
    n3.append(total)
    print("Took " + total + "sec \n---")
    ...
    start = time.perf_counter()
    AStar.explore(State(3,[3,2,8,4,5,6,7,1,0]), State(3,[1,2,3,4,5,6,7,8,0]), 2, 200)
    totalraw = time.perf_counter() - start
    total = str(round(totalraw,6))
    n3.append(total)
    print("Took " + total + "sec \n---")
    ...
    start = time.perf_counter()
    AStar.explore(State(3,[3,2,8,4,5,6,7,1,0]), State(3,[1,2,3,4,5,6,7,8,0]), 2, 200, 0)
    totalraw = time.perf_counter() - start
    total = str(round(totalraw,6))
    n3.append(total)
    print("Took " + total + "sec \n---")
    ...
    start = time.perf_counter()
    AStar.explore(State(3,[3,2,8,4,5,6,7,1,0]), State(3,[1,2,3,4,5,6,7,8,0]), 2, 50)
    totalraw = time.perf_counter() - start
    total = str(round(totalraw,6))
    n3.append(total)
    print("Took " + total + "sec \n---")
    ...
    start = time.perf_counter()
    AStar.explore(State(3,[3,2,8,4,5,6,7,1,0]), State(3,[1,2,3,4,5,6,7,8,0]), 2, 50, 0)
    totalraw = time.perf_counter() - start
    total = str(round(totalraw,6))
    n3.append(total)
    print("Took " + total + "sec \n---")
    ...
    start = time.perf_counter()
    AStar.explore(State(3,[5,0,8,4,2,1,7,3,6]), State(3,[1,2,3,4,5,6,7,8,0]), 2)
    totalraw = time.perf_counter() - start
    total = str(round(totalraw,6))
    n3.append(total)
    print("Took " + total + "sec \n---")
    ...
    start = time.perf_counter()
    AStar.explore(State(3,[1,2,0,4,5,3,7,8,6]), State(3,[1,2,3,4,5,6,7,8,0]), 2)
    totalraw = time.perf_counter() - start
    total = str(round(totalraw,6))
    n3.append(total)
    print("Took " + total + "sec \n---")
...
with open("tester_n3_h2.csv", "w", newline="") as f:
